...
const PRODUCTS = [
  { id: '1', name: 'Wireless Headphones', price: 149.99, image: 'https://via.placeholder.com/100' },
  ...
  { id: '5', name: 'Wireless Earbuds', price: 89.99, image: 'https://via.placeholder.com/100' },
];
    ...
    <View style={styles.container}>
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          <ProductItem
            product={item}
            onAddToCart={() => {}} // Replace with actual implementation
          />
        )}
      />
    </View>
